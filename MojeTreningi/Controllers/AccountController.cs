...
namespace MojeTreningi.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, string imie, string nazwisko, DateTime dataUrodzenia)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    Profil profil = new Profil { UserName = model.Email, Imie = imie, Nazwisko = nazwisko, DataUrodzenia = dataUrodzenia };
                    MojeTreningiContext db = new MojeTreningiContext();
                    db.Profile.Add(profil);
                    db.SaveChanges();
